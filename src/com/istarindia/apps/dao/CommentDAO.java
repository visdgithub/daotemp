 ...
 * 
 * @see com.istarindia.apps.dao.Comment
...
public class CommentDAO extends BaseHibernateDAO {
	...
	public Comment findById(java.lang.Integer id) {
		...
		try {
			Comment instance = (Comment) getSession().get("com.istarindia.apps.dao.Comment", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Comment> findByExample(Comment instance) {
		...
		try {
			List<Comment> results = (List<Comment>) getSession().createCriteria("com.istarindia.apps.dao.Comment")
	...
	public List<Comment> findByComment(Object comment) {
