 ...
 * 
 * @see com.istarindia.apps.dao.Course
...
public class CourseDAO extends BaseHibernateDAO {
	...
	public Course findById(java.lang.Integer id) {
		...
		try {
			Course instance = (Course) getSession().get("com.istarindia.apps.dao.Course", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Course> findByExample(Course instance) {
		...
		try {
			List<Course> results = (List<Course>) getSession().createCriteria("com.istarindia.apps.dao.Course")
